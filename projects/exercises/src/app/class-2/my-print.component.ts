...
@Component({
    ...
    template: `
        <button class="app-my-print-10-reload" nz-button (click)="print()">Print me again</button>
        <div>
...
export class MyPrintComponent implements AfterViewInit {
    ...
    // @ts-ignore
    @ViewChild('myPrint', {static: true}) canvasPrint10REf: ElementRef<HTMLCanvasElement>;
    // @ts-ignore
